...
type UserRepository interface {
	GetByResetPassword(ctx context.Context, token string) (*entity.User, error)
...
func (u *userRepository) GetByResetPassword(ctx context.Context, token string) (*entity.User, error) {
	result := new(entity.User)
